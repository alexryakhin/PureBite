...
final class BottomSheetPresentationController: UIPresentationController {
    ...
    private static let sheetStretchOffset: CGFloat = 4
    ...
    override func presentationTransitionWillBegin() {
        ...
        let preferredHeightConstraint =
        if sheetSizingFactor == 0 {
            presentedView.heightAnchor.constraint(lessThanOrEqualTo: bottomSheetLayoutGuide.heightAnchor, constant: -Self.sheetStretchOffset)
        } else {
            presentedView.heightAnchor.constraint(equalToConstant: bottomSheetLayoutGuide.layoutFrame.height * sheetSizingFactor)
        }
