...
public protocol SessionStorageAbstract: AnyObject {
...
public final class SessionStorage: SessionStorageAbstract {

    private let keychainStorage: KeychainStorageAbstract

    public init(keychainStorage: KeychainStorageAbstract) {
