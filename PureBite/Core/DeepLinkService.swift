...
public protocol DeepLinkServiceInterface {
    func tryFindAndHandle(dynamicLink url: URL) -> Bool
    func handle(userActivity: NSUserActivity) -> Bool
    func applicationDidOpenUrl(_ url: URL) -> Bool
    func applicationDidReceiveDynamicLink(_ linkString: String, userActivityUrlString: String) -> Bool
    func tryHandleDeepLink(from payload: [AnyHashable: Any])
    func resetDeepLink()
}

// TODO: integrate FirebaseDynamicLinks
