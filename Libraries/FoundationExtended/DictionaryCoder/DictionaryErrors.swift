...
internal extension EncodingError {
    ...
    static func _invalidFloatingPointValue<T: FloatingPoint>(
        ...
        Unable to encode \(valueDescription) directly in Dictionary. Use
        DictionaryEncoder.NonConformingFloatEncodingStrategy.convertToString to specify how the value should be encoded.
        """
